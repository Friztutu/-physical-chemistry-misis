...
class Task2Calculus:
    ...
    In = {
        0.5: {80: (5.24, 3.14), 120: (3.38, 2.03), 150: (3.38, 2.03), 160: (2.28, 1.37), 200: (2.28, 1.37),
              250: (2.1, 1.26), 300: (1.77, 1.06)},
        1: {80: (4.2, 2.52), 120: (2.91, 1.75), 150: (2.56, 1.54), 160: (2.24, 1.34), 200: (1.79, 1.07),
            250: (1.60, 0.96), 300: (1.34, 0.8)},
    ...
    def step_three(self, Ln):
        ...
        if not (0.5 <= self.current_density <= 2):
            return True
...
if __name__ == '__main__':
    task2 = Task2Calculus(2, 1, 250, 2, 15, 0.3, 40)
    print(task2())
